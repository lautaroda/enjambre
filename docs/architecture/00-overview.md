...
3. **Verificación/anti-abuso** — redundancia (mandar el mismo tramo de cómputo a 2-3 nodos y comparar) en vez de criptografía de verificación de inferencia (zkML sigue siendo demasiado lento/caro para LLMs en producción). Ver `03-verification.md`.
...
- `03-verification.md` — diseño detallado de Nivel 1/Nivel 2 (hoy vive en `docs/roadmap.md`, mover acá cuando se implemente).
